...
<html>
  ...
  <div data-role="header" data-position="fixed">
    ...
    <h4>成绩查询</h4>
    <a href="${pageContext.request.contextPath }/checkError?FromUserName=${FromUserName}" data-icon="info">报错</a>
  </div>
    <div data-role="content">
 	
	  	 <form action="${pageContext.request.contextPath }/queryScore" method="post" data-ajax=“false”>
		  	<label style="width: 100%;text-align: center;">欢迎你：<c:if test="${!empty FromUserName }">
			 ${FromUserName }
			</c:if></label>
			<br><br>
		    ...
		    <input type="hidden" value="<%= session.getAttribute("FromUserName") %>" name="FromUserName"/> 
		    <br>   
		    <input type="submit" value="查询" data-icon="Check" data-iconpos="top">
